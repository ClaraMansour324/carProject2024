...
<html lang="en">
  ...
  <head>
    <title>CarRental &mdash; by Clara Mansour</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="site-wrap" id="home-section">
            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  <li class="active"><a href="<?php echo e(route('index')); ?>" class="nav-link">Home</a></li>
                  <li><a href="<?php echo e(route('listing')); ?>" class="nav-link">Listing</a></li>
                  <li><a href="<?php echo e(route('testimonials')); ?>" class="nav-link">Testimonials</a></li>
                  <li><a href="<?php echo e(route('blog')); ?>" class="nav-link">Blog</a></li>
                  <li><a href="<?php echo e(route('about')); ?>" class="nav-link">About</a></li>
      ...
      <div class="hero" style="background-image: url('<?php echo e(asset('assets/images/hero_1_a.jpg')); ?>');">
          ...
          <div class="row align-items-center">
            <div class="col-lg-7 text-center order-lg-2">
              <div class="img-wrap-1 mb-5">
                <img src="<?php echo e(asset('assets/images/feature_01.png')); ?>" alt="Image" class="img-fluid">
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="<?php echo e(asset('assets/images/car_6.jpg')); ?>" alt="Image" class="img-fluid">
              </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="<?php echo e(asset('assets/images/car_5.jpg')); ?>" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
                <h3>Nissan Moco</h3>
                <div class="rent-price">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="<?php echo e(asset('assets/images/car_4.jpg')); ?>" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
                <h3>Honda Fitta</h3>
                <div class="rent-price">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="<?php echo e(asset('assets/images/car_3.jpg')); ?>" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
                <h3>Skoda Laura</h3>
                <div class="rent-price">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="<?php echo e(asset('assets/images/car_2.jpg')); ?>" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
                <h3>Mazda LaPuta</h3>
                <div class="rent-price">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="<?php echo e(asset('assets/images/car_1.jpg')); ?>" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
        ...
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="<?php echo e(asset('assets/images/person_1.jpg')); ?>" alt="Image" class="img-fluid mr-3">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="<?php echo e(asset('assets/images/person_2.jpg')); ?>" alt="Image" class="img-fluid mr-3">
                <div class="author-name">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="<?php echo e(asset('assets/images/person_3.jpg')); ?>" alt="Image" class="img-fluid mr-3">
                <div class="author-name">
...
<?php /**PATH C:\xampp\htdocs\carProject\resources\views/layouts/index.blade.php ENDPATH**/ ?>